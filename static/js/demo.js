...
(function ($, AdminLTE) {
  ...
  var skin_blue =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 7px; background: #0073b7;'></span><span class='bg-light-blue' style='display:block; width: 80%; float: left; height: 7px;'></span></div>"
